<?php
/** Randevu formu sayfası (POST işleme AppointmentController'da) */
$errors = $_SESSION['form_errors'] ?? [];
unset($_SESSION['form_errors']);

$breadcrumbs = [
    ['name' => t('breadcrumb.home'), 'path' => ''],
    ['name' => t('title.appointment'), 'path' => 'randevu-al'],
];
$meta = [
    'title'       => t('title.appointment') . ' — ' . setting('location_text', 'İstanbul / Bağcılar'),
    'description' => t('form.appointment_text'),
    'canonical'   => 'randevu-al',
];
...
<section class="page-hero">
    <div class="container">
        ...
        <h1><?= e(t('form.appointment_title')) ?></h1>
        <p class="lead"><?= e(t('form.appointment_text')) ?></p>
    </div>
</section>
<section class="section">
    <div class="container form-wrap">
        ...
        <?php endif; ?>
        <div class="form-card">
            <form method="post" action="<?= e(url('randevu-al')) ?>" enctype="multipart/form-data" novalidate>
                <?= Csrf::field() ?>
                <input type="text" name="website" value="" class="hp-field" tabindex="-1" autocomplete="off" aria-hidden="true">
                <div class="form-grid">
                    <?php $withBudget = false; require BASE_PATH . '/app/views/layout/form-tattoo-fields.php'; ?>
                </div>
